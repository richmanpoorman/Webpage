...
function Sidebar({className = "", currentContent, setCurrentContent} : SidebarProps) : ReactElement {
    ...
    const workExperienceTab : ReactElement = <button className={"sidebar-resume-button sidebar-button "   + decideSelected("Work Experience")}   onClick={setViewFunction("Work Experience")}>Experience</button>
