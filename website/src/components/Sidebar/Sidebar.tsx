...
function Sidebar({className = "", currentContent, setCurrentContent} : SidebarProps) : ReactElement {
    ...
    const githubLink    : ReactElement  = <a className="header-github-link header-link-icon" href="https://github.com/richmanpoorman"><FaGithub /></a>
    const linkedinLink  : ReactElement  = <a className="header-linkedin-link header-link-icon" href="https://www.linkedin.com/in/matthewkw/"><FaLinkedin /></a> // TODO : Replace with icons
